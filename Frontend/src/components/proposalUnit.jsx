...
const proposalUnit = (props) => {
  ...
  return (
    <div
      ...
      className="sm:h-[100px] lg:h-[100px] w-1/2 bg-opacity-50 bg-[#1d1f31] rounded-2xl hover:bg-[#34394d] transition duration-300 ease-in-out cursor-pointer">
      <h1 className="flex flex-row min-h-[100px] text-xl text-center items-center justify-center ">
        {`${props.getProposalsFunc[props.index][4]} `}
